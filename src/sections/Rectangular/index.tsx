    ...
    <section key="5">
      ...
      <section key="5-1">
        ...
        <aside className={"notes"}>
          k = Wellenzahl. k beschreibt, wie viele wellen in einem Meter hineinpassen. Geschwindigkeit der Schwingung. Vergleichbar mit Omega
        </aside>
      </section>
      <section key="5-2">
        ...
        <Typography variant="body1" sx={{ mt: 2 }}>
          ...
          jeweils eine ganzzahlige Anzahl ({'$m, n$'}) von <strong>Halbwellen</strong> {'($\\frac{\\lambda}{2}$)'} ausbilden muss:
        </Typography>
      ...
      <section key="5-5">
        ...
        <Typography variant="body1">
          Da allgemein {'$k = \\frac{2\\pi}{\\lambda} = \\frac{2\\pi \\cdot f}{c}$'} gilt, setzen wir für den Grenzwert ein:
        </Typography>
        ...
        <aside className="notes">
          Das ist das Endergebnis unserer Herleitung. Das Pi fliegt komplett raus, weil es sowohl in der Wellenbewegung steckt als auch in den Geometriebedingungen der Wand. Übrig bleibt eine reine Formel, die uns für jeden m-n-Modus sagt, ab wie viel Hertz das Rohr anfängt zu leiten!
        </aside>
      </section>
